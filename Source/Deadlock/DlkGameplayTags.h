...
namespace DlkGameplayTags
{
	...
	DEADLOCK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_Burn);

	DEADLOCK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Behavior_SurvivesDeath);

	DEADLOCK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_Reset);
	DEADLOCK_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_RequestReset);
};
