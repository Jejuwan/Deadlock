...
UCLASS()
class DEADLOCK_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
public:
	...
	void Step3_HandleExperienceLoaded(const UDlkExperienceDefinition* CurrentExperience);
