...
#include "DlkSystemStatics.generated.h"
...
UCLASS()
class UDlkSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Dlk", meta = (WorldContext = "WorldContextObject"))
