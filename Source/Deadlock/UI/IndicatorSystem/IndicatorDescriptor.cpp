...
#include "SceneView.h"
#include "Deadlock/UI/IndicatorSystem/DlkIndicatorManagerComponent.h"
...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UDlkIndicatorManagerComponent* InManager)
{
...
{
	if (UDlkIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
