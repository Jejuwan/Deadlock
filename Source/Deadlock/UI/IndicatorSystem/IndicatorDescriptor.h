...
class DEADLOCK_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UDlkIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UDlkIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UDlkIndicatorManagerComponent> ManagerPtr;
