...
#include "DlkVerbMessageHelpers.h"

#include "GameFramework/Pawn.h"
#include "GameFramework/PlayerController.h"
#include "GameFramework/PlayerState.h"
#include "GameplayEffectTypes.h"
#include "DlkVerbMessage.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(DlkVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FDlkVerbMessage

FString FDlkVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FDlkVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UDlkVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UDlkVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UDlkVerbMessageHelpers::VerbMessageToCueParameters(const FDlkVerbMessage& Message)
{
...
FDlkVerbMessage UDlkVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FDlkVerbMessage Result;
