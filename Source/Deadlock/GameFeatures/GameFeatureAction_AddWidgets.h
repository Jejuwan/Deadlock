...
//
//USTRUCT()
//struct FDlkHUDElementEntry
//{
//	GENERATED_BODY()
//
//	/** DlkHUDLayout 위에 올릴 대상이 되는 Widget Class */
//	UPROPERTY(EditAnywhere, Category = UI)
//	TSoftClassPtr<UUserWidget> WidgetClass;
//
//	/** SlotID는 DlkHUDLayoutRequest에 올린 LayoutClass에 정의된 Slot(GameplayTag)를 의미 */
//	UPROPERTY(EditAnywhere, Category = UI)
//	FGameplayTag SlotID;
//};
//
//UCLASS()
//class DEADLOCK_API UGameFeatureAction_AddWidgets : public UGameFeatureAction_WorldActionBase
//{
//	GENERATED_BODY()
//public:
...
//	 */
//	UPROPERTY(EditAnywhere, Category=UI)
//	TArray<FDlkHUDLayoutRequest> Layout;
//
//	UPROPERTY(EditAnywhere, Category=UI)
//	TArray<FDlkHUDElementEntry> Widgets;
//};
